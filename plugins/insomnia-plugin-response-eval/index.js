...
module.exports.templateTags = [
  {
    ...
    args: [
      ...
      },
      {
        ...
        description:
          'Pre filter the output. If the output is an array, filter the items by this value (string: indexOf, regex: match(with tokens being returned as the output if they exist)',
      },
      {
        type: 'string',
        displayName: 'JavaScript Code',
        description:
          'The variable named `output` contains the output of the original response template tag.',
        placeholder: 'output',
      },
    ],
